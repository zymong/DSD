...
# python eval_things_occ_sf.py testset=flyingthings3d_subset_flownet3d model=camliga_l ckpt.path=outputs/camliga_l/2024-05-16/17-35-25/ckpts/epoch-100.pt
# python eval_things_occ_sf.py testset=flyingthings3d_subset_flownet3d model=camliraft_l ckpt.path=outputs/camliraft_l/2024-05-09/16-37-26/ckpts/epoch-100.pt
# python eval_things_occ_sf.py testset=ft3d model=camliraft_l ckpt.path=outputs/camliraft_l/2024-05-09/16-37-26/ckpts/epoch-100.pt
# python eval_things_occ_sf.py testset=ft3do model=gmsf ckpt.path=/home/wxy/code/camliga/outputs/gmsf/2024-12-17/13-15-06/ckpts/epoch-160.pt
...
class FlyingThings3DSubsetFlowNet3D(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        with open(self.datapath[index], 'rb') as fp:
            ...
            noc_mask = data['valid_mask1'].astype(bool)
