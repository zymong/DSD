...
# python demo.py --model camliga --weights checkpoints/camligac_things145e.pt
# python demo.py --model gmsf --weights checkpoints/gmsfgru_f3da_8192.pt
...
class Demo:
    ...
    def prepare_images_and_depths(self):
        ...
        flow_3d = flow_3d[indices1]

        return image1, image2, pc1, pc2, flow_3d
    ...
    def run(self):
        ...
        image1, image2, pc1, pc2, flow_3d = self.prepare_images_and_depths()
        ...
        flow_3d = torch.from_numpy(flow_3d).float().unsqueeze(0)
        # inference
        # inputs = {'images': images, 'pcs': pcs, 'intrinsics': intrinsics, 'flow_3d': flow_3d}
        inputs = {'pcs': pcs, 'intrinsics': intrinsics, 'flow_3d': flow_3d}
    ...
    def display(self, image1, image2, pc1, pc2, flow_2d, flow_3d):
        ...
        # save 
        n_points = args.n_points  # 获取点云数量
        open3d.io.write_point_cloud(f"result/point_cloud1_{n_points}.ply", point_cloud1)
        open3d.io.write_point_cloud(f"result/point_cloud2_{n_points}.ply", point_cloud2)
        open3d.io.write_point_cloud(f"result/point_cloud3_{n_points}.ply", point_cloud3)
    ...
    def save_sf(self, pc1, pc2, flow_3d):
...
if __name__ == '__main__':
    ...
    assert args.model in ['camlipwc', 'camliraft', 'camliga', 'gmsf']
