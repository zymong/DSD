...
# python eval_sintel.py testset=sintel model=camliga ckpt.path=checkpoints/camliga_things80e.pt
# python eval_sintel.py testset=sintel model=camliga ckpt.path=checkpoints/camliga_things150e_kitti790e.pt
# python eval_sintel.py testset=sintel model=camliga ckpt.path=checkpoints/camligac_things145e.pt
